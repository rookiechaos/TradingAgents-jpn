...
def test_no_env_uses_built_in_defaults(monkeypatch):
    ...
    assert dc.DEFAULT_CONFIG["output_language"] == "Japanese"
    assert dc.DEFAULT_CONFIG["market_profile"] == "jp_equity"
...
def test_string_overrides(monkeypatch):
    dc = _reload_with_env(
        ...
        TRADINGAGENTS_MARKET_PROFILE="global",
    )
    ...
    assert dc.DEFAULT_CONFIG["market_profile"] == "global"
